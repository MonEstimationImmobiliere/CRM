  ...
  <div>
    <Dialog v-model:show="dialogs.dialog1.show" :loading="dialogs.dialog1.loading"
      ...
      <template #modalFooter>
        <ElButton @click="dialogs.dialog1.show = false">Fermer</ElButton>
        <ElButton type="primary" @click="dialogs.dialog1.show = false">Valider</ElButton>
      </template>
    </Dialog>
    <ElButton @click="showDialog(randomPick(Object.values(transitions)))">transition</ElButton>
    <ElButton @click="showDialog(transitions.fade)">fade</ElButton>
    <ElButton @click="showDialog(transitions.fadeScale)">fade-scale</ElButton>
    <ElButton @click="showDialog(transitions.slideUp)">slide-up</ElButton>
    <ElButton @click="showDialog(transitions.slideDown)">slide-down</ElButton>
    <ElButton @click="showDialog(transitions.slideLeft)">slide-left</ElButton>
    <ElButton @click="showDialog(transitions.slideRight)">slide-right</ElButton>
  </div>
</template>
