    ...
    <div class="hamburger-menu">
      ...
      <nav :data-state="menuState">
        <ul>
          ...
          <li>
            <RouterLink to="/reminders" @click="closeMenu">Rappels</RouterLink>
          </li>
          <li>
            <RouterLink to="/favorites" @click="closeMenu">Favoris</RouterLink>
          </li>
        </ul>
      </nav>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 align-self-center">
            ...
            <p>
              ...
              ci-dessous pour retourner à l'accueil.
            </p>
