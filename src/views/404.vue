<template>
  <div class="error-page">
    <div class="hamburger-menu">
      <button class="burger" data-state="closed" @click="toggleMenu">
        <span></span>
        <span></span>
        <span></span>
      </button>
      <nav :data-state="menuState">
        <ul>
          <li><RouterLink to="/" @click="closeMenu">Accueil</RouterLink></li>
          <li><RouterLink to="/dashboard" @click="closeMenu">Dashboard</RouterLink></li>
          <li><RouterLink to="/reminders" @click="closeMenu">Rappels</RouterLink></li>
          <li><RouterLink to="/favorites" @click="closeMenu">Favoris</RouterLink></li>
        </ul>
      </nav>
    </div>
        ...
        <div class="row">
          <div class="col-md-6 align-self-center">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g>
                ...
                <g id="planet">
                  <circle fill="none" stroke="#002e51" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803"
                    r="90.788" />
                  <circle id="craterBig" fill="none" stroke="#002e51" stroke-width="3" stroke-miterlimit="10" cx="548.891"
                    cy="62.319" r="13.074" />
                  <circle id="craterSmall" fill="none" stroke="#002e51" stroke-width="3" stroke-miterlimit="10" cx="591.743"
                    cy="158.918" r="7.989" />
                  <path id="ring" fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round"
                    stroke-miterlimit="10" d="
              M476.562,101.461c-30.404,2.164-49.691,4.221-49.691,8.007c0,6.853,63.166,12.408,141.085,12.408s141.085-5.555,141.085-12.408
              c0-3.378-15.347-4.988-40.243-7.225" />
                  <path id="ringShadow" opacity="0.5" fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round"
                    stroke-miterlimit="10" d="
              M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                ...
                <g id="stars">
                  <g id="starsBig">
                    <g>
                      <line fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                  ...
                  <g id="circlesBig">
                    <circle fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                  ...
                  <g id="circlesSmall">
                    <circle fill="#002e51" cx="549.879" cy="296.402" r="2.651" />
                    <circle fill="#002e51" cx="253.29" cy="229.24" r="2.651" />
                    <circle fill="#002e51" cx="434.824" cy="263.931" r="2.651" />
                    <circle fill="#002e51" cx="183.708" cy="544.176" r="2.651" />
                    <circle fill="#002e51" cx="382.515" cy="530.923" r="2.651" />
                    <circle fill="#002e51" cx="130.693" cy="305.608" r="2.651" />
                    <circle fill="#002e51" cx="480.296" cy="477.014" r="2.651" />
                  </g>
                </g>
                
                <g id="spaceman" clip-path="url(cordClip)">
                  <path id="cord" fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" stroke-miterlimit="10"
                    d="
              M273.813,410.969c0,0-54.527,39.501-115.34,38.218c-2.28-0.048-4.926-0.241-7.841-0.548
              c-68.038-7.178-134.288-43.963-167.33-103.87c-0.908-1.646-1.793-3.3-2.654-4.964c-18.395-35.511-37.259-83.385-32.075-118.817" />

                  <path id="backpack" fill="#FFFFFF" stroke="#002e51" stroke-width="3" stroke-linecap="round"
              ...
              C360.647,451.083,349.251,457.661,338.164,454.689z" />
                  ...
                  <g id="antenna">
                    <line fill="#FFFFFF" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                      stroke-miterlimit="10" x1="323.396" y1="236.625" x2="295.285" y2="353.753" />
                    <circle fill="#FFFFFF" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                      stroke-miterlimit="10" cx="323.666" cy="235.617" r="6.375" />
                  </g>
                  
                  <g id="armR">
                    <path fill="#FFFFFF" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                      stroke-miterlimit="10" d="
                  ...
                  c26.513,7.108,53.771-8.632,60.883-35.158l1.374-5.123C371.778,395.999,365.971,377.536,353.351,365.387z" />
                    <path fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                      stroke-miterlimit="10" d="
                  ...
                  <g id="legs">
                    <g id="legR">
                      ...
                      <line fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <g id="head">
                    <ellipse transform="matrix(0.259 -0.9659 0.9659 0.259 -51.5445 563.2371)" fill="#FFFFFF"
                      stroke="#002e51" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                      stroke-miterlimit="10" cx="341.295" cy="315.211" rx="61.961" ry="60.305" />
                    <path id="headStripe" fill="none" stroke="#002e51" stroke-width="3" stroke-linecap="round"
                      stroke-linejoin="round" stroke-miterlimit="10" d="
                  ...
                  s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
                    <g clip-path="url(#GlassClip)">
                      <polygon id="glassShine" fill="none" stroke="#002e51" stroke-width="3" stroke-miterlimit="10" points="
          ...
          <div class="col-md-6 align-self-center">
            <div class="logo-section">
              <svg class="company-logo" width="48" height="48" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class="btn green" @click="goHome">ACCUEIL</button>
          </div>
        </div>
      </div>
    </main>
...
onMounted(() => {
  // Charger GSAP depuis CDN pour les animations
